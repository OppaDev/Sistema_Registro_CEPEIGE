...
export const ROLE_PERMISSIONS = {
  ...
  COURSES_DELETE: [ROLES.SUPER_ADMIN, ROLES.ADMIN], // DELETE /cursos/:id
  ...
  PERSONAL_DATA_DELETE: [ROLES.SUPER_ADMIN, ROLES.ADMIN], // DELETE
  ...
  BILLING_DATA_DELETE: [ROLES.SUPER_ADMIN, ROLES.ADMIN],
  ...
  VOUCHERS_DELETE: [ROLES.SUPER_ADMIN, ROLES.ADMIN],
  ...
  INSCRIPTIONS_DELETE: [ROLES.SUPER_ADMIN, ROLES.ADMIN],
