...
export { toCursoResponseDto } from '@/api/services/mappers/inscripcionMapper/curso.mapper';
...
export { toDescuentoResponseDto } from '@/api/services/mappers/inscripcionMapper/descuento.mapper';
